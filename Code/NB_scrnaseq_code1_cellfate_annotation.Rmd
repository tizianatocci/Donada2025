...
logcs_dtB <- FeaturePlot(expB.realdata, features = "Log2CS", reduction = "umap_expB_sct", pt.size = 3) + labs(title = "Dataset B", color = "Log2CS") + default_theme + theme(legend.text = element_text(size = font_size_legend)) +  scale_color_gradient(
...
pseudo_dtB <- slingshot_B[["umap_pseudotime"]] + labs(title = "Dataset B") + default_theme + theme(legend.text = element_text(size = font_size_legend))+
labs(color = "Pseudotime") 
pseudo_dtB                                  
...
```{r}
spearman_correlation <- function(slingshot_df, col_vector, plot_title, pseudotime_col = "pseudotime", col_name = "Log2CS") {
...
# Dataset A
resultA <- spearman_correlation(
  slingshot_df = slingshot_A[["df"]],
  col_vector = expA.realdata$Log2CS,
...
# Dataset B
resultB <- spearman_correlation(
  slingshot_df = slingshot_B[["df"]],
  col_vector = expB.realdata$Log2CS,
...
```{r}
ggsave(resultA[["fig"]] , 
       filename = "../Figures/Fig_splog2cspseudotime_datasetA.svg",
       device = "svg",
       height = 6, width = 6.5, units = "in")
ggsave(resultB[["fig"]] , 
       filename = "../Figures/Fig_splog2cspseudotime_datasetB.svg",
       device = "svg",
       height = 6, width = 6.5, units = "in")
```
