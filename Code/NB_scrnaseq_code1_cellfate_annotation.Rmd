...
```{r}
spearman_correlation <- function(slingshot_df, col_vector, pseudotime_col = "pseudotime", col_name = "Colony_size") {
  ...
  cat("Spearman correlation coefficient for is:", result, "\n")
...
resultA <- spearman_correlation(
  ...
  col_vector = expA.realdata$Colony_size,
  pseudotime_col = "pseudotime",
  col_name = "Colony_size"
)

# Dataset B
resultB <- spearman_correlation(
  slingshot_df = slingshot_B[["df"]],
  col_vector = expB.realdata$Colony_size,
  pseudotime_col = "pseudotime",
  col_name = "Colony_size"
)
